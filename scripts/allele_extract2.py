...
#----------------------------------- write out individual results into txt or csv file
...
#----------------------------------- Alternative: write out the id list as rows in files
        allelefull_list = json.dumps(allelefull_dict)
        allelecompare = []
        allelecompare.append(allelefull_dict)
